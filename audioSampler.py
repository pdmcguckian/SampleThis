...
class RecordNotes():
    ...
    def __init__(self, file_path, file_names):
        ...
        self.file_names = file_names #names of audio files
        ...
        #Loops continuously, so whever q pressed audio can be recorded
        print("q to record.")
        while True:
...
file_path = "/Users/pdmcguckian/Documents/Projects 4/Audio Experience/SampleThis/"
